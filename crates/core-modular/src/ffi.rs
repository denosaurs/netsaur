...
#[no_mangle]
pub extern "C" fn ffi_sequential_create(ptr: *const u8, len: usize, alloc: AllocBufferFn) -> usize {
...
#[no_mangle]
pub extern "C" fn ffi_sequential_train(
    id: usize,
...
#[no_mangle]
pub extern "C" fn ffi_sequential_predict(
    id: usize,
...
#[no_mangle]
pub extern "C" fn ffi_sequential_save(id: usize, alloc: AllocBufferFn) {
    RESOURCES.with(|cell| {
...
#[no_mangle]
pub extern "C" fn ffi_sequential_load(
    file_ptr: *const u8,
    file_len: usize,
    alloc: AllocBufferFn,
) -> usize {
